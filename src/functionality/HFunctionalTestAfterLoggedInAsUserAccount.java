...
public class HFunctionalTestAfterLoggedInAsUserAccount {
  ...
  @Test
  public void testFunctionalTestAfterLoggedInAsUserAccount() throws Exception {
    ...
    driver.findElement(By.name("firstName")).sendKeys("testers");
